...
public class CachedFriendRepository implements FriendRepository {
    ...
    @Override
    @Cached(name = CacheNames.FRIENDS_USER, key = "#userId.value()", cacheType = CacheType.REMOTE,
    ...
    @Override
    @Cached(name = CacheNames.FRIEND_ACTIVE, key = "#userId.value() + ':' + #friendUserId.value()",
    ...
    @Override
    @CacheInvalidate(name = CacheNames.FRIENDS_USER, key = "#friend.getUserId().value()")
    @CacheInvalidate(name = CacheNames.FRIEND_EDGE, key = "#friend.getUserId().value() + ':' + #friend.getFriendUserId().value()")
    @CacheInvalidate(name = CacheNames.FRIEND_ACTIVE, key = "#friend.getUserId().value() + ':' + #friend.getFriendUserId().value()")
