...
public class CachedUserRepository implements UserRepository {
    ...
    @Override
    @CacheInvalidate(name = CacheNames.USER_ID, key = "#user.getId().value()")
    @CacheInvalidate(name = CacheNames.USER_EMAIL, key = "#user.getEmail().value()")
    @CacheInvalidate(name = CacheNames.USER_EMAIL_CONTAIN, key = "#user.getEmail().value()")
    ...
    @Override
    @Cached(name = CacheNames.USER_EMAIL_CONTAIN, key = "#email.value()", cacheType = CacheType.REMOTE,
