...
const consoles: Record<ConsoleKey, Omit<ConsoleLink, "key">> = {
  ...
  audit: {
    name: "审计中心",
    location:
      import.meta.env.VITE_AUDIT_CONSOLE_URL || "http://localhost:18041",
  },
  monitor: {
    name: "运行监控",
    location:
      import.meta.env.VITE_MONITOR_CONSOLE_URL || "http://localhost:18043",
  },
  admin: {
    name: "用户管理",
    location:
      import.meta.env.VITE_ADMIN_CONSOLE_URL || "http://localhost:18042",
  },
};
